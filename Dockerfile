...
#Import Gudz
RUN wget https://raw.githubusercontent.com/darkXstar-xd/Fire-X/master/firebotmain.py
RUN wget https://raw.githubusercontent.com/darkXstar-xd/Fire-X/master/requirements.txt
#Start Fumkin
